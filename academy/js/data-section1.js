            ...
            html: `
              ...
              <div class="install-step-carousel has-captions">
                <div class="install-step-captions">
                  ...
                  <div class="install-step-caption"><span class="install-step-caption-label">Step 2 of 4</span><strong>Create a Search Engine</strong><p>Configure the data type (Product or Other data), the indexing method (File or Feed URL, or API), the results language, and — for product data — the currency, then click <img class="inline-ui-img" src="img/btn-create-search-engine-form.png" alt="Create Search Engine button">.</p></div>
