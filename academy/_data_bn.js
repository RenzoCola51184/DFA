        ...
        blocks: [
          {
            html: `
              ...
              <figure class="lesson-figure lesson-figure-right" style="width: 360px; max-width: 55%;">
                  <img src="img/banners-add-form.png" alt="Add Banner form: a Write a name field at the top, the Status toggle switched on, the Default banner toggle switched off with the note Use this banner by default when no banner matches the search terms, Duration with Run this result continously starting today (ongoing) selected and Set date period as the other option, and Search Terms with an Exact Match dropdown, a Type a search term field and an Add term button" data-action="zoom-image">
                  <p class="example-caption" title="Click the image to enlarge it" aria-label="Click the image to enlarge it"><svg viewBox="0 0 16 16" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="6.5" cy="6.5" r="4.5"></circle><line x1="10" y1="10" x2="14" y2="14" stroke-linecap="round"></line></svg></p>
                </figure>
